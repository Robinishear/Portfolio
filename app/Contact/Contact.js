...
export default function Contact() {
    ...
    <div className="flex justify-center py-10 min-h-screen ">
      <div className="flex  flex-col md:flex-row gap-20 max-w-5xl w-full px-4">
        ...
        <form
          ...
          className=" p-6 w-full max-w-md shadow-smrelative font-bold rounded-2xl px-5 py-2 shadow-lg  hover:shadow-cyan-400/60  transition duration-1000 border border-gray-300"
          autoComplete="off"
        >
          <div className="mb-5">
            <label
          ...
          <button
            type="submit"
            className="w-full relative font-bold  rounded-2xl px-5 py-2 shadow-lg  hover:shadow-cyan-400/60  transition duration-1000 bg-gradient-to-r from-black via-gray-900 to-black"
          >
            Send Message
          </button>
        </form>
        ...
        {/* Right Information */}
        <div className="p-6 w-full max-w-md shadow-smrelative font-bold rounded-2xl px-5 py-2 shadow-lg  hover:shadow-cyan-400/60  transition duration-1000 border border-gray-300">
  ...
  <Link
    ...
    className="cursor-pointer relative font-bold  rounded-2xl px-5 py-2 shadow-lg  hover:shadow-cyan-400/60  transition duration-1000"
  >
    <FaFacebookF />
  </Link>
